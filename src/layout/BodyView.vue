  ...
  >
    ...
    <div class="page-body-wrapper">
      <div
        ...
        :data-layout="
          storeLayout.svg == 'stroke-svg' ? 'stroke-svg' : 'fill-svg'
        "
        :class="[
          {
            close_icon: !store.togglesidebar,
            'sidebar-default': store.perentName,
          },
        ]"
      >
...
const Header = defineAsyncComponent(
  () => import("@/components/common/block/header/index.vue")
);
const Sidebar = defineAsyncComponent(
  () => import("@/components/common/block/sidebar/index.vue")
);
...
watch(
  ...
  () => {
    if (
      ...
      storeLayout.layouts.settings.layout === "Horizontal"
    ) {
      ...
      layoutobj.value = JSON.parse(JSON.stringify(newlayout))[
        storeLayout.layouts.settings.layout
      ];
    } else {
