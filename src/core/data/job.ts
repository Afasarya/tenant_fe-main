...
export const jobs: details[] = [
  ...
  },
  {
    ...
    title: "Designer, CRM",
    description:
      "Situation admitting promotion at or to perceived be. Mr acuteness we as estimable enjoyment up. An held late as felt know. Learn do allow solid to grave. Middleton suspiFico age her attention. Chiefly several bed its wishing. Is so moments on chamber pressed to. Doubtful yet way properly answered.",
    company: "Citrix",
    city: "Lelystad",
    country: "Netherlands",
    stars: 4,
  ...
  },
  {
    ...
    title: "Designer, CRM",
    description:
      "Situation admitting promotion at or to perceived be. Mr acuteness we as estimable enjoyment up. An held late as felt know. Learn do allow dashed to grave. Middleton suspicion age her attention. Chiefly several bed its wishing. Is so moments on chamber pressed to. Doubtful yet way properly answered.",
    company: "Citrix",
    city: "",
    country: " Lelystad, Netherlands ",
    stars: 3,
  ...
  },
  {
    ...
    title: "UI/UX IT Frontend Developer",
    description:
      "We are looking for an experienced and Fico designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role. You won’t be a team of one though — you’ll be collaborating closely with other...",
    company: "",
    city: "",
...
export const data: list[] = [
  {
    ...
    title: "React/React Native Developer",
    description:
      "This is an incredibly exciting opportunity to gain commercial , Professional experience of React Native. Transform product wireframes into responsive, mobile user interface components and Ideally 2+ years experience with React. Bonus points if you have React Native experience.",
    company: "San",
    city: "Diego",
    country: "CA ",
    date: "",
  ...
  },
  {
    ...
    title: "Front end web developer",
    description:
      "Professional experience of React Native and other front end frameworks. Transform product wireframes into responsive, mobile user interface components and Bonus points if you have React Native experience. This is an incredibly exciting opportunity to gain commercial.",
    company: "Cisco",
    city: "Lelystad",
    country: "Netherlands",
    date: "3 days ago",
  ...
  },
  {
    ...
    title: "Graphic designer",
    description:
      "Transform product wireframes into responsive, mobile user interface components and Ideally 2+ years experience with React. Bonus points if you have React Native experience. Professional experience of React Native and other front end frameworks.",
    company: "Infosys",
    city: "Lelystad",
    country: "Netherlands",
    date: "3 days ago",
  ...
  },
  {
    ...
    title: "Designer, CRM",
    description:
      "Bonus points if you have React Native experience. This is an incredibly exciting opportunity. Professional experience of React Native frameworks. Transform product wireframes into responsive, mobile user interface components and Ideally 2+ years experience with React.",
    company: "Citrix",
    city: "Lelystad",
    country: "Netherlands",
    date: "3 days ago",
