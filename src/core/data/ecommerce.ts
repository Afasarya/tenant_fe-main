...
export const invoice = [
  {
    ...
    name: "Billed To",
    style: "width: 46%",
    title: "Fico Matchett Vandelay Group LTD",
  },
  {
    class: "width: 21%;",
    class1: "opacity: 0.8;",
...
export const datatable = [
  {
    style:
      "box-shadow: 0px 10.9412px 10.9412px rgba(82, 77, 141, 0.04), 0px 9.51387px 7.6111px rgba(82, 77, 141, 0.06), 0px 5.05275px 4.0422px rgba(82, 77, 141, 0.0484671);border-radius: 5.47059px;",
    children: [
      {
        class: "padding: 18px 15px;display:flex;align-items: center;gap: 10px;",
        title: "Project",
        style:
          "min-width: 7px;height: 7px;border: 4px solid #7A70BA;background: #fff;border-radius: 100%;display: inline-block;",
      },
      {
    ...
    children: [
      {
        ...
        style:
          "min-width: 7px;height: 7px;border: 4px solid #FF3364;background: #fff;border-radius: 100%;display: inline-block;",
      },
      {
        class: "padding: 18px 15px;",
        title: "$8,000.00",
    ...
    children: [
      {
        ...
        style:
          "min-width: 7px;height: 7px;border: 4px solid #FFAE46;background: #fff;border-radius: 100%;display: inline-block;",
      },
      {
        class: "padding: 18px 15px;",
        title: "$2,000.00",
    ...
    children: [
      {
        ...
        style:
          "min-width: 7px;height: 7px;border: 4px solid #54BA4A;background: #fff;border-radius: 100%;display: inline-block;",
      },
      {
        class: "padding: 18px 15px;",
        title: "$2,000.00",
...
export const invoice2 = [
  {
    style:
      "display:flex;align-items:center; gap: 6px;flex-wrap: wrap;min-width: 136px;",
  ...
  {
    style:
      "display:flex;align-items:center; gap: 6px; flex-wrap: wrap;min-width: 146px;",
    style1: "opacity: 0.8; font-size: 16px; font-weight: 500;",
    name: "Payment Status :",
    class:
      "margin:0;font-weight:400; font-size: 16px;padding:6px 18px; background-color:rgba(84, 186, 74, 0.1);color:#0DA759; border-radius: 5px;",
    title: "Paid",
  },
  {
...
export const addres = [
  {
    ...
    descclass:
      "width: 54%; display:block; line-height: 1.5; opacity: 0.8; font-size: 16px; font-weight: 400;",
    desc: " 2118 Thornridge Cir. Syracuse, Connecticut 35624, United State",
    numberclass:
      "line-height:2.6; opacity: 0.8; font-size: 16px; font-weight: 400;",
  ...
  },
  {
    ...
    descclass:
      "width: 95%; display:block; line-height: 1.5; opacity: 0.8; font-size: 16px; font-weight: 400;",
...
export const invoicetable1 = [
  {
    class: "invoice-dark",
    style:
      "background-color: rgba(123, 111, 183, 0.1);box-shadow: 0px 1px 0px 0px rgba(82, 82, 108, 0.15);",
    img: "product_list/product-categories/laptop.png",
    title: "Apple Desktop",
    subtitle: "#XDG-6437",
    qty: "2",
...
export const invoiceheader1 = [
  ...
  {
    style:
      "padding: 18px 15px; text-align: center; border-inline: 3px solid #fff;",
    title: "Qty",
  },
  {
    style:
      "padding: 18px 15px; text-align: center;border-right: 3px solid #fff;",
    title: "Price",
  },
  {
...
export const invoiceheader2 = [
  {
    style:
      "padding: 18px 15px;text-align: left; position: relative; border-top-left-radius: 10px;",
    title: "Description",
  },
  {
    style: "padding: 18px 15px;text-align: center",
  ...
  {
    style:
      "padding: 18px 15px;text-align: center;position: relative; border-top-right-radius: 10px;",
    title: "Subtotal",
  },
];
...
export const invoiceadd = [
  {
    style:
      "font-weight:600;font-size: 16px; color: #7A70BA; display: block; margin-bottom: 8px;",
    title: "Brooklyn Simmons",
  },
  {
    style:
      "width: 75%; display:block; line-height: 1.5;  font-size: 16px; font-weight: 400;opacity: 0.8;",
    title: "2972  Westheimer Rd. Santa Ana, Illinois 85486 ",
  },
  {
    style:
      "line-height:1.9;  font-size: 16px; font-weight: 400;opacity: 0.8; display:block;",
    title: "Phone : (219) 555-0114",
  },
  {
    style:
      "line-height:1.7;  font-size: 16px; font-weight: 400;opacity: 0.8; display:block;",
...
export const invoiceadd1 = [
  {
    style:
      "display:block; line-height: 1.5;  font-size: 16px; font-weight: 400;opacity: 0.8;",
  ...
  },
  {
    style:
      "display:block; line-height: 1.5;  font-size: 16px; font-weight: 400;opacity: 0.8;",
    title: "Email : Fico@themesforest.com",
  },
  {
    style:
      "display:block; line-height: 1.5;  font-size: 16px; font-weight: 400;opacity: 0.8;",
    title: "Website: www.Ficothemes.com",
  },
];
export const data1 = [
  {
    style:
      "font-size: 16px; display:block; font-weight: 600; color:rgba(122, 112, 186, 1); margin-bottom: 14px;",
    title: "Invoice to :",
  },
  {
    style:
      "font-size: 16px; display:block; font-weight: 600; color:#7A70BA; margin-bottom: 8px;",
    title: "Brooklyn Simmons",
  },
  {
    style:
      "font-size: 16px; display:block;  opacity: 0.8; margin-bottom: 8px; width: 72%; line-height: 1.4;",
    title: "2972 Westheimer Rd. Santa Ana, Illinois 85486",
  },
  {
...
export const data2 = [
  {
    style:
      "font-size: 16px;color: #7A70BA; display: block; font-weight: 600; margin-bottom: 20px;",
    title: "Bank Transfer",
  },
  {
    style:
      "color: #7A70BA; display: block; margin-bottom: 12px; font-weight: 600;",
...
export const tableheader = [
  {
    style:
      "padding: 18px 15px;text-align: center; position: relative; border-top-left-radius: 10px;",
    title: "No.",
  },
  {
...
export const tablesection = [
  {
    style:
      "width: 12%; text-align: center; border-bottom: 1px dashed rgba(82, 82, 108, 0.2);background: rgba(122, 112, 186 , 0.1);",
    nostyle: "opacity: 0.8; font-weight: 600;",
    no: "1",
    titleclass:
      "padding: 16px; border-bottom: 1px dashed rgba(82, 82, 108, 0.2);",
    titlestyle:
      "font-weight:600; margin:4px 0px; font-size: 16px; color: #7A70BA;",
    title: "Proposal & Brochure Design",
    ...
    price: "$300.00",
    qtystyle:
      "width: 12%; text-align: center; border-bottom: 1px dashed rgba(82, 82, 108, 0.2);",
    qty: "1",
    totalstyle:
      "width: 12%; text-align: center; border-bottom: 1px dashed rgba(82, 82, 108, 0.2);background: rgba(122, 112, 186 , 0.1);",
    total: "$300.00",
  ...
  },
  {
    ...
    qty: "Subtotal",
    totalstyle:
      "text-align: center;background: rgba(122, 112, 186 , 0.1); display: block; padding:35px 0 18px;",
    total: "$6100.00",
    totalclass: "color: #7A70BA; font-weight: 600;opacity: 0.9;",
  },
  {
    ...
    qty: "VAT / Tax 15%",
    totalstyle:
      "text-align: center;background: rgba(122, 112, 186 , 0.1); display:block; padding-bottom: 18px;",
    total: "$50.00",
    totalclass: "color: #7A70BA; font-weight: 600;opacity: 0.9;",
  },
  {
  ...
  },
  {
    ...
    total: "$6120.00",
    totalclass:
      "color: #ffffff; font-weight: 600;opacity: 0.9;background: #7A70BA; padding: 12px 37px; margin-top: 0px; display: block;",
  },
];
