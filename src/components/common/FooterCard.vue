<template>
  <Card3
    ...
    footersClass="text-end"
    :cardbodyClass="item.bodyclass"
    :titleClass="item.class"
    :cardhaderClass="item.haderclass"
    headerTitle="true"
    :title="item.title"
    footertitle="Fico Theme"
  >
...
let desc = ref<string>(
  "Star rating is displayed using <code>#u-rating-fontawesome-o </code> id using javascript."
);
</script>
